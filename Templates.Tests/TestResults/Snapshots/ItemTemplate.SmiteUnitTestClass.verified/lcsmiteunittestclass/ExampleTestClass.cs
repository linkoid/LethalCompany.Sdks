...
namespace MyPlugin.Tests
{
    ...
    public class ExampleTestClass : MonoBehaviour
    {
        private static ExampleTestClass Instance = null!;
        ...
        {
            Instance = new GameObject($"{nameof(ExampleTestClass)}").AddComponent<ExampleTestClass>();
            GameObject.DontDestroyOnLoad(Instance.gameObject);
            Instance.gameObject.hideFlags = HideFlags.HideAndDontSave;

            Logger = BepInEx.Logging.Logger.CreateLogSource(typeof(ExampleTestClass).Assembly.GetName().Name);
        }
